...
class ConnectionManager extends ConnectionManager_Base
{
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "juridica_at_172_18_0_115";
		$data["connName"] = "juridica at 172.18.0.115";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;172.18.0.115;root;9H1IgEtLAG;;juridica;;1"; //currently unused

		$this->_connectionsIdByName["juridica at 172.18.0.115"] = "juridica_at_172_18_0_115";

		$data["connInfo"] = array();
		$data["ODBCUID"] = "root";
		$data["ODBCPWD"] = "9H1IgEtLAG";
		$data["leftWrap"] = "`";
		$data["rightWrap"] = "`";
		...
		$data["connInfo"][0] = "172.18.0.115";
		$data["connInfo"][1] = "root";
		$data["connInfo"][2] = "9H1IgEtLAG";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "juridica";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 8.0 Unicode Driver};Server=172.18.0.115;Uid=root;Pwd=9H1IgEtLAG;Database=juridica;OPTION=3";
		// encription set
		...
		$connectionsData["juridica_at_172_18_0_115"] = $data;
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "mcit_users_at_172_18_0_115";
		$data["connName"] = "mcit_users at 172.18.0.115";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;172.18.0.115;root;9H1IgEtLAG;;mcit_users;;1"; //currently unused

		$this->_connectionsIdByName["mcit_users at 172.18.0.115"] = "mcit_users_at_172_18_0_115";
		...
		$data["connInfo"][2] = "9H1IgEtLAG";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "mcit_users";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 8.0 Unicode Driver};Server=172.18.0.115;Uid=root;Pwd=9H1IgEtLAG;Database=mcit_users;OPTION=3";
		// encription set
		$data["EncryptInfo"] = array();
		$data["EncryptInfo"]["mode"] = 0;
		$data["EncryptInfo"]["alg"]  = 128;
		...
		$connectionsData["mcit_users_at_172_18_0_115"] = $data;
