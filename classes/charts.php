...
//				$this->strLabel = $params['name'];
	...
	protected function isProjectDB()
	{
		...
		if("cc_coactivo" == $this->chrt_array['tables'][0])
			return true;
		if("cc_tparam_clase_sancion" == $this->chrt_array['tables'][0])
			return true;
		if("cc_tparam_remitente" == $this->chrt_array['tables'][0])
			return true;
		if("cc_tparam_tiempo_prescripcion" == $this->chrt_array['tables'][0])
			return true;
		if("cc_tparam_estado" == $this->chrt_array['tables'][0])
			return true;
		if("global_users" == $this->chrt_array['tables'][0])
			return true;
		if("cc_gesionjuridica_v103_ugrights" == $this->chrt_array['tables'][0])
			return true;
		if("global_users" == $this->chrt_array['tables'][0])
			return true;
		if("cc_coactivo_anexos" == $this->chrt_array['tables'][0])
			return true;
		if("cc_coactivo_anexos_tipo" == $this->chrt_array['tables'][0])
			return true;
		if("cc_titulos" == $this->chrt_array['tables'][0])
			return true;
		if("cc_tparam_sn" == $this->chrt_array['tables'][0])
			return true;
		if("cc_acuerdo_pago" == $this->chrt_array['tables'][0])
			return true;
		if("global_users" == $this->chrt_array['tables'][0])
			return true;
		if("cc_actuaciones" == $this->chrt_array['tables'][0])
			return true;
		if("cc_plan_pago" == $this->chrt_array['tables'][0])
			return true;
		if("q_prescipcicion" == $this->chrt_array['tables'][0])
			return true;
		if("q_actuaciones" == $this->chrt_array['tables'][0])
			return true;
		if("cc_tparam_tipodoc" == $this->chrt_array['tables'][0])
			return true;
		if("cc_tparam_caracter" == $this->chrt_array['tables'][0])
			return true;
		if("rj_master" == $this->chrt_array['tables'][0])
			return true;
		if("rj_tparam_tipodeproceso" == $this->chrt_array['tables'][0])
			return true;
		if("rj_tparam_estado" == $this->chrt_array['tables'][0])
			return true;
		if("q_divipola" == $this->chrt_array['tables'][0])
			return true;
		if("rj_tparam_etapajudicial" == $this->chrt_array['tables'][0])
			return true;
		if("rj_tparam_probabilidadperdercas" == $this->chrt_array['tables'][0])
			return true;
		if("rj_master_audiencias" == $this->chrt_array['tables'][0])
			return true;
		if("rj_master_anexos" == $this->chrt_array['tables'][0])
			return true;
		if("sc_master" == $this->chrt_array['tables'][0])
			return true;
		if("sc_tparam_tipo" == $this->chrt_array['tables'][0])
			return true;
		if("sc_tparam_tema" == $this->chrt_array['tables'][0])
			return true;
		if("sc_tparam_estadoentrega" == $this->chrt_array['tables'][0])
			return true;
		if("global_users" == $this->chrt_array['tables'][0])
			return true;
		if("rj_tparam_sn" == $this->chrt_array['tables'][0])
			return true;
		if("rj_tparam_calidad" == $this->chrt_array['tables'][0])
			return true;
		if("rj_master_provision_contable" == $this->chrt_array['tables'][0])
			return true;
		return false;
	}
