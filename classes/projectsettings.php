...
class ProjectSettings
{
	...
	*/
	...
	function getConnId()
	{
		...
		if( $connId == "" ) {
			return "juridica_at_172_18_0_115";
		}
		return $connId;
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "cc_coactivo" ] = array( "url" => "cc_coactivo", "type" => 0 );
	$projectEntitiesReverse[ "cc_coactivo" ] = "cc_coactivo";
	$projectEntities[ "cc_tparam_clase_sancion" ] = array( "url" => "cc_tparam_clase_sancion", "type" => 0 );
	$projectEntitiesReverse[ "cc_tparam_clase_sancion" ] = "cc_tparam_clase_sancion";
	$projectEntities[ "cc_tparam_remitente" ] = array( "url" => "cc_tparam_remitente", "type" => 0 );
	$projectEntitiesReverse[ "cc_tparam_remitente" ] = "cc_tparam_remitente";
	$projectEntities[ "cc_tparam_tiempo_prescripcion" ] = array( "url" => "cc_tparam_tiempo_prescripcion", "type" => 0 );
	$projectEntitiesReverse[ "cc_tparam_tiempo_prescripcion" ] = "cc_tparam_tiempo_prescripcion";
	$projectEntities[ "cc_tparam_estado" ] = array( "url" => "cc_tparam_estado", "type" => 0 );
	$projectEntitiesReverse[ "cc_tparam_estado" ] = "cc_tparam_estado";
	...
	$projectEntities[ "cc_coactivo_anexos" ] = array( "url" => "cc_coactivo_anexos", "type" => 0 );
	$projectEntitiesReverse[ "cc_coactivo_anexos" ] = "cc_coactivo_anexos";
	$projectEntities[ "cc_coactivo_anexos_tipo" ] = array( "url" => "cc_coactivo_anexos_tipo", "type" => 0 );
	$projectEntitiesReverse[ "cc_coactivo_anexos_tipo" ] = "cc_coactivo_anexos_tipo";
	$projectEntities[ "cc_titulos" ] = array( "url" => "cc_titulos", "type" => 0 );
	$projectEntitiesReverse[ "cc_titulos" ] = "cc_titulos";
	$projectEntities[ "cc_tparam_sn" ] = array( "url" => "cc_tparam_sn", "type" => 0 );
	$projectEntitiesReverse[ "cc_tparam_sn" ] = "cc_tparam_sn";
	$projectEntities[ "cc_acuerdo_pago" ] = array( "url" => "cc_acuerdo_pago", "type" => 0 );
	$projectEntitiesReverse[ "cc_acuerdo_pago" ] = "cc_acuerdo_pago";
	$projectEntities[ "global_users_find" ] = array( "url" => "global_users_find", "type" => 1 );
	$projectEntitiesReverse[ "global_users_find" ] = "global_users_find";
	$projectEntities[ "cc_actuaciones" ] = array( "url" => "cc_actuaciones", "type" => 0 );
	$projectEntitiesReverse[ "cc_actuaciones" ] = "cc_actuaciones";
	$projectEntities[ "cc_plan_pago" ] = array( "url" => "cc_plan_pago", "type" => 0 );
	$projectEntitiesReverse[ "cc_plan_pago" ] = "cc_plan_pago";
	$projectEntities[ "q_prescipcicion" ] = array( "url" => "q_prescipcicion", "type" => 0 );
	$projectEntitiesReverse[ "q_prescipcicion" ] = "q_prescipcicion";
	$projectEntities[ "q_actuaciones" ] = array( "url" => "q_actuaciones", "type" => 0 );
	$projectEntitiesReverse[ "q_actuaciones" ] = "q_actuaciones";
	$projectEntities[ "cc_tparam_tipodoc" ] = array( "url" => "cc_tparam_tipodoc", "type" => 0 );
	$projectEntitiesReverse[ "cc_tparam_tipodoc" ] = "cc_tparam_tipodoc";
	$projectEntities[ "cc_tparam_caracter" ] = array( "url" => "cc_tparam_caracter", "type" => 0 );
	$projectEntitiesReverse[ "cc_tparam_caracter" ] = "cc_tparam_caracter";
	$projectEntities[ "rj_master" ] = array( "url" => "rj_master", "type" => 0 );
	$projectEntitiesReverse[ "rj_master" ] = "rj_master";
	$projectEntities[ "rj_tparam_tipodeproceso" ] = array( "url" => "rj_tparam_tipodeproceso", "type" => 0 );
	$projectEntitiesReverse[ "rj_tparam_tipodeproceso" ] = "rj_tparam_tipodeproceso";
	$projectEntities[ "rj_tparam_estado" ] = array( "url" => "rj_tparam_estado", "type" => 0 );
	$projectEntitiesReverse[ "rj_tparam_estado" ] = "rj_tparam_estado";
	$projectEntities[ "q_divipola" ] = array( "url" => "q_divipola", "type" => 0 );
	$projectEntitiesReverse[ "q_divipola" ] = "q_divipola";
	$projectEntities[ "rj_tparam_etapajudicial" ] = array( "url" => "rj_tparam_etapajudicial", "type" => 0 );
	$projectEntitiesReverse[ "rj_tparam_etapajudicial" ] = "rj_tparam_etapajudicial";
	$projectEntities[ "rj_tparam_probabilidadperdercas" ] = array( "url" => "rj_tparam_probabilidadperdercas", "type" => 0 );
	$projectEntitiesReverse[ "rj_tparam_probabilidadperdercas" ] = "rj_tparam_probabilidadperdercas";
	$projectEntities[ "rj_master_audiencias" ] = array( "url" => "rj_master_audiencias", "type" => 0 );
	$projectEntitiesReverse[ "rj_master_audiencias" ] = "rj_master_audiencias";
	$projectEntities[ "rj_master_anexos" ] = array( "url" => "rj_master_anexos", "type" => 0 );
	$projectEntitiesReverse[ "rj_master_anexos" ] = "rj_master_anexos";
	$projectEntities[ "sc_master" ] = array( "url" => "sc_master", "type" => 0 );
	$projectEntitiesReverse[ "sc_master" ] = "sc_master";
	$projectEntities[ "sc_tparam_tipo" ] = array( "url" => "sc_tparam_tipo", "type" => 0 );
	$projectEntitiesReverse[ "sc_tparam_tipo" ] = "sc_tparam_tipo";
	$projectEntities[ "sc_tparam_tema" ] = array( "url" => "sc_tparam_tema", "type" => 0 );
	$projectEntitiesReverse[ "sc_tparam_tema" ] = "sc_tparam_tema";
	$projectEntities[ "sc_tparam_estadoentrega" ] = array( "url" => "sc_tparam_estadoentrega", "type" => 0 );
	$projectEntitiesReverse[ "sc_tparam_estadoentrega" ] = "sc_tparam_estadoentrega";
	$projectEntities[ "admin_users" ] = array( "url" => "admin_users", "type" => 1 );
	$projectEntitiesReverse[ "admin_users" ] = "admin_users";
	$projectEntities[ "rj_tparam_sn" ] = array( "url" => "rj_tparam_sn", "type" => 0 );
	$projectEntitiesReverse[ "rj_tparam_sn" ] = "rj_tparam_sn";
	$projectEntities[ "rj_tparam_calidad" ] = array( "url" => "rj_tparam_calidad", "type" => 0 );
	$projectEntitiesReverse[ "rj_tparam_calidad" ] = "rj_tparam_calidad";
	$projectEntities[ "rj_master_provision_contable" ] = array( "url" => "rj_master_provision_contable", "type" => 0 );
	$projectEntitiesReverse[ "rj_master_provision_contable" ] = "rj_master_provision_contable";
}
