...
require_once("include/rj_master_provision_contable_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "rj_master_provision_contable" );
