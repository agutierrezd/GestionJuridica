...
function checkTableName($shortTName )
{
	...
	if ("cc_coactivo" == $shortTName )
		return true;
	if ("cc_tparam_clase_sancion" == $shortTName )
		return true;
	if ("cc_tparam_remitente" == $shortTName )
		return true;
	if ("cc_tparam_tiempo_prescripcion" == $shortTName )
		return true;
	if ("cc_tparam_estado" == $shortTName )
		return true;
	...
	if ("admin_members" == $shortTName )
		return true;
	if ("cc_coactivo_anexos" == $shortTName )
		return true;
	if ("cc_coactivo_anexos_tipo" == $shortTName )
		return true;
	if ("cc_titulos" == $shortTName )
		return true;
	if ("cc_tparam_sn" == $shortTName )
		return true;
	if ("cc_acuerdo_pago" == $shortTName )
		return true;
	if ("global_users_find" == $shortTName )
		return true;
	if ("cc_actuaciones" == $shortTName )
		return true;
	if ("cc_plan_pago" == $shortTName )
		return true;
	if ("q_prescipcicion" == $shortTName )
		return true;
	if ("q_actuaciones" == $shortTName )
		return true;
	if ("cc_tparam_tipodoc" == $shortTName )
		return true;
	if ("cc_tparam_caracter" == $shortTName )
		return true;
	if ("rj_master" == $shortTName )
		return true;
	if ("rj_tparam_tipodeproceso" == $shortTName )
		return true;
	if ("rj_tparam_estado" == $shortTName )
		return true;
	if ("q_divipola" == $shortTName )
		return true;
	if ("rj_tparam_etapajudicial" == $shortTName )
		return true;
	if ("rj_tparam_probabilidadperdercas" == $shortTName )
		return true;
	if ("rj_master_audiencias" == $shortTName )
		return true;
	if ("rj_master_anexos" == $shortTName )
		return true;
	if ("sc_master" == $shortTName )
		return true;
	if ("sc_tparam_tipo" == $shortTName )
		return true;
	if ("sc_tparam_tema" == $shortTName )
		return true;
	if ("sc_tparam_estadoentrega" == $shortTName )
		return true;
	if ("admin_users" == $shortTName )
		return true;
	if ("rj_tparam_sn" == $shortTName )
		return true;
	if ("rj_tparam_calidad" == $shortTName )
		return true;
	if ("rj_master_provision_contable" == $shortTName )
		return true;
	return false;
}
...
function GetTablesList($pdfMode = false)
{
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("cc_coactivo");
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("cc_tparam_clase_sancion");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="cc_tparam_clase_sancion";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("cc_tparam_remitente");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="cc_tparam_remitente";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("cc_tparam_tiempo_prescripcion");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="cc_tparam_tiempo_prescripcion";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("cc_tparam_estado");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="cc_tparam_estado";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("cc_coactivo_anexos");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="cc_coactivo_anexos";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("cc_coactivo_anexos_tipo");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="cc_coactivo_anexos_tipo";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("cc_titulos");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("cc_tparam_sn");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("cc_acuerdo_pago");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("global_users_find");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="global_users_find";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("cc_actuaciones");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("cc_plan_pago");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_prescipcicion");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_actuaciones");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("cc_tparam_tipodoc");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="cc_tparam_tipodoc";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("cc_tparam_caracter");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="cc_tparam_caracter";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("rj_master");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("rj_tparam_tipodeproceso");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="rj_tparam_tipodeproceso";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("rj_tparam_estado");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="rj_tparam_estado";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("rj_tparam_etapajudicial");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="rj_tparam_etapajudicial";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("rj_tparam_probabilidadperdercas");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="rj_tparam_probabilidadperdercas";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("rj_master_audiencias");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="rj_master_audiencias";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("rj_master_anexos");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="rj_master_anexos";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("sc_master");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("sc_tparam_tipo");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("sc_tparam_tema");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("sc_tparam_estadoentrega");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="sc_tparam_estadoentrega";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("rj_tparam_sn");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("rj_tparam_calidad");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="rj_tparam_calidad";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("rj_master_provision_contable");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="rj_master_provision_contable";
	}
	return $arr;
}
...
function GetUserPermissionsStatic( $table )
{
	...
	$extraPerm = "";
	if( $table=="cc_coactivo" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="cc_tparam_clase_sancion" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="cc_tparam_remitente" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="cc_tparam_tiempo_prescripcion" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="cc_tparam_estado" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="cc_coactivo_anexos" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="cc_coactivo_anexos_tipo" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="cc_tparam_sn" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="cc_acuerdo_pago" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="global_users_find" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="cc_actuaciones" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="cc_plan_pago" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="q_prescipcicion" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="q_actuaciones" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="cc_tparam_tipodoc" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="cc_tparam_caracter" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="rj_tparam_tipodeproceso" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="rj_tparam_estado" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="rj_tparam_etapajudicial" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="rj_tparam_probabilidadperdercas" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="rj_master_audiencias" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="rj_master_anexos" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="sc_tparam_tipo" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="sc_tparam_tema" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="sc_tparam_estadoentrega" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="rj_tparam_sn" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="rj_tparam_calidad" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="rj_master_provision_contable" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
